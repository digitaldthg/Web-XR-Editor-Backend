<template>
  <div class="slide-component-wrapper" v-if="$store.state.selectedMesh != null">
    <div
      ...
      v-if="
        $store.state.selectedMesh.userData.slideElements.element.Type.Type ===
          'Primitive'
      "
    >
      <template>
        ...
        <template v-if="toggleOpen">
          <Dropdown
            title="PrimitiveType"
            :options="['Cube', 'Cone', 'Cylinder', 'Sphere', 'Torus', 'Plane']"
            :value="
              $store.state.selectedMesh.userData.slideElements.element.Primitive
                .PrimitiveType
            "
          ...
          <MaterialField
            ...
            :value="
              $store.state.selectedMesh.userData.slideElements.element.Color
            "
          />
        </template>
      </template>
